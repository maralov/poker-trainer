...
> ## ⚠️ Архітектура змінилась після Фази 1
>
> Цей план писався з припущенням, що проект навчальний: власна auth обґрунтована
> «навчальною цінністю», бекенд — «ціллю навчання Python-бекенду». Проект виявився
> продакшн-орієнтованим, тож ця основа зникла.
>
> **Що діє замість Фаз 2–5 нижче:** Supabase (Postgres + Google-логін + RLS),
> без власного бекенду. Фази 0–1 виконані як описано і не змінювались.
> Актуальний стан архітектури — у `CLAUDE.md`, розділ «Архітектура».
>
> Фази 2–5 нижче лишені як історія рішень: за ними видно, що саме змінилось і чому.
